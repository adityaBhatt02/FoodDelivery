...
import com.project.foodiesapi.entity.OrderEntity;
import com.project.foodiesapi.io.OrderRequest;
import com.project.foodiesapi.io.OrderResponse;
import com.project.foodiesapi.repository.CartRepository;
import com.project.foodiesapi.repository.OrderRepository;
...
public class OrderServiceImpl implements OrderService {
    ...
    private OrderResponse convertToResponse(OrderEntity newOrder) {
        return OrderResponse.builder()
                ...
                .orderedItems(newOrder.getOrderedItem())
                .build();
    }
